...
interface FsStorage {
    fun store(document: InflowDocument, node: Node): List<VirtualFile>

    fun restore(document: InflowDocument, chunk: List<VirtualFile>): InflowDocument
}
...
class InflowDocumentFilesystemStorage(
    ...
    private fun storeSimpleNode(document: InflowDocument, node: Node): List<VirtualFile> {
    ...
    private fun textExtension(document: InflowDocument, node: Node, section: NodeTextSection): String {
    ...
    private fun ensurePort(node: Node, name: String, direction: PortDirection) {
        ...
        node.ports += com.orchestra.core.model.NodePort(id, name, direction)
    }
}
...
private fun nodeFullPath(document: InflowDocument, node: Node): String {
